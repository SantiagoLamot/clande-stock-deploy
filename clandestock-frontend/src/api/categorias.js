...
export const darBajaCategoria = async (id) => {
  const response = await axios.put(`/categoria/${id}/baja`);
  return response.data;
};

export const darAltaCategoria = async (id) => {
  const response = await axios.put(`/categoria/${id}/alta`);
  return response.data;
};
